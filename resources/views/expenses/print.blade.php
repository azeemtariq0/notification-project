...
body { box-sizing: border-box; height: 6in; margin: 0 auto; overflow: hidden; padding: 0.5in; width: 4.5in; }
...
@page { margin: 0; }
	...
	<body>
		<header>
			...
			<address >
				<p>Pharmacy Store</p>
				<p>Date : {{ date('d M Y',strtotime($exp_date))}} | Invoice no : {{ $exp_code}}</p>
			</address>
